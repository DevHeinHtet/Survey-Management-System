<div class="w-full md:w-[70%] h-full bg-white rounded-md shadow-md shadow-gray-400 p-3">
	<form action="{{route('manager.report.business.export')}}" class="md:p-4" method="post" autocomplete="off">
		@csrf
		<h1 class="text-3xl mb-6 text-center">Business Report</h1>
			...
			<ul class="items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 sm:flex">
				<li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
					<div class="flex items-center pl-3">
						...
						<label for="excel" class="py-2.5 ml-2 w-full text-sm font-medium text-gray-900">Excel</label>
					</div>
				</li>
				<li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
					<div class="flex items-center pl-3">
						...
						<label for="print" class="py-2.5 ml-2 w-full text-sm font-medium text-gray-900">Print</label>
					</div>
				</li>
			</ul>
		...
		<div class="space-y-2 text-sm mt-3">
			...
			<select name="business_type" class="p-2.5 w-full text-sm bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
		...
		<div class="space-y-2 mt-3">
			<label for="small" class="text-sm">Status</label>
			<select name="status" class="p-2.5 w-full text-sm bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
				<option value="all">All</option>
		...
		<div class="space-y-2 mt-3">
			<label for="" class="text-sm">Period</label>
			<select name="period" class="period p-2.5 text-sm w-full bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
		...
		<div class="mt-4">
			<button type="submit" class="w-full text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-md text-sm font-bold text-center py-3">Export</button>
		</div>
	</form>
</div>
